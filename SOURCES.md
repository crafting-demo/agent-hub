...
| --- | --- |
| product-manager | [anthropics/knowledge-work-plugins](https://github.com/anthropics/knowledge-work-plugins) product-management (23.9k); [Agent Skills](https://agentskills.io/specification) |
| engineering-manager | [google/adk-python](https://github.com/google/adk-python) SequentialAgent (21k); [Anthropic subagents](https://code.claude.com/docs/en/sub-agents) |
...
| qa-engineer | Anthropic fresh-session verification; [microsoft/playwright](https://github.com/microsoft/playwright) (96k) |
| code-reviewer | [anthropics/claude-code](https://github.com/anthropics/claude-code) (145k) pr-review-toolkit; [GitHub Copilot review-code](https://docs.github.com/en/copilot/tutorials/customization-library/prompt-files/review-code); OWASP Top 10 |
